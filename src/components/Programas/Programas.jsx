...
export default function Programas() {
  ...
  const programasData = [
    ...
    {
      id: "abc-digital-steam",
      categoria: "educacion",
      icon: "💻",
      titulo: "ABC Digital STEAM",
      categoriaTag: "Educación y Transformación Digital",
      badge: "Programa Educativo",
      descripcion:
        "ABC Digital STEAM impulsa la formación de niños, jóvenes y comunidades mediante el acceso a la educación, la tecnología y el desarrollo de competencias digitales para construir nuevas oportunidades.",
      impacto: "Educación, tecnología y oportunidades para el futuro",
      meta: "Proyección 2027: Ampliación de programas de formación STEAM",
      detalles: [
        "Formación en competencias digitales y tecnológicas",
        "Programas educativos orientados al aprendizaje STEAM",
        "Desarrollo de habilidades para el estudio y el mundo laboral",
        "Acceso a herramientas y recursos para fortalecer el aprendizaje",
        "Creación de nuevas oportunidades mediante la educación digital",
      ],
    },
  ];
      ...
      <section id="servicios" className="programas-section">
        <div className="programas-container">
          ...
          <div className="filter-buttons-bar">
            ...
            <button
              className={`filter-btn ${filter === "educacion" ? "active" : ""}`}
